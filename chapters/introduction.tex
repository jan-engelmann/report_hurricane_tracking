% TODO check if all references are placed correctly
% TODO check if I wrote Tropical cyclones not Cyclones everywhere

% TODO Include occurrence plots
% TODO Make 20 different Track matching plots and include them potentially change coloring to see better different tracks
% TODO Make Intensity vs Occurence plot
% TODO track matching plot label start end endpoints with color and temdif (?or param_id rather not)
% TODO Reduce all TC entries to one tracking file
% - For Hurricanes Category 1 or higher either include or exclude 1 point. Only look at endings of track
% - Tropical depression stages expect them to be in 20 percent of all combos
% - Tropical storm expect them to occur in 30% of all combos
